...
data1 <- read.csv("coastal_population_vs_mismanaged_plastic.csv", stringsAsFactors = FALSE)
data2 <- read.csv("inadequately-managed-plastic.csv", stringsAsFactors = FALSE)
data3 <- read.csv("mismanaged-plastic-waste-by-region-2010.csv", stringsAsFactors = FALSE)
data4 <- read.csv("mismanaged-waste-global-total.csv", stringsAsFactors = FALSE)
data5 <- read.csv("per-capita-mismanaged-plastic-waste-vs-gdp-per-capita.csv", stringsAsFactors = FALSE)
data6 <- read.csv("per-capita-plastic-waste-vs-gdp-per-capita.csv", stringsAsFactors = FALSE)
data7 <- read.csv("plastic-waste-generation-total.csv", stringsAsFactors = FALSE)
data8 <- read.csv("plastic-waste-per-capita.csv", stringsAsFactors = FALSE)
dev.country <- read.csv("country-codes.csv", stringsAsFactors = FALSE)
GDP <- read.csv("GDP.csv", stringsAsFactors = FALSE)
Income <- read.csv("INCOME.csv", stringsAsFactors = FALSE)
continents <- read.csv("Countries-Continents.csv", stringsAsFactors = FALSE)
